          ...
          <div class="updateinfo">
            <div class="left">
              <el-form-item label="账号" prop="useraccount">
                <el-input v-model="form.useraccount" :disabled="isInput"></el-input>
              </el-form-item>
              <el-form-item label="名字" prop="username">
                <el-input v-model="form.username" :disabled="isInput"></el-input>
              </el-form-item>
              <el-form-item label="性别" prop="usergender" >
                <el-radio v-model="form.usergender" label="男" :disabled="isInput">男</el-radio>
                <el-radio v-model="form.usergender" label="女" :disabled="isInput">女</el-radio>
              </el-form-item>
            ...
            <div class="right">
              ...
              <el-form-item label="所在大学" prop="userunit">
                <el-input v-model="form.userunit" :disabled="isInput"></el-input>
              </el-form-item>
