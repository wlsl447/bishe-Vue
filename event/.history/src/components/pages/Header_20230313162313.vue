    ...
    <el-row :gutter="4" type="flex" justify="space-between">
      ...
      <el-col :span="18">
        ...
        >
          ...
          <el-menu-item index="/noticeManager">系统公告</el-menu-item>
        </el-menu>
      </el-col>
        ...
        <div>
          ...
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="userGroup">个人信息</el-dropdown-item>
              <el-dropdown-item command="userGroup">投诉建议</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
