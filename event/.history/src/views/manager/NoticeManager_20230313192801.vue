...
<el-descriptions class="margin-top" :title="item.title" :column="1" direction="vertical">
  <el-descriptions-item label="发布时间">{{ item.time | formatTimer}}</el-descriptions-item>
