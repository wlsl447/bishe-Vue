  ...
  <div>
    ...
    >
      <div>
        <el-form ref="tableDatafrom" :model="dialogData" label-width="120px">
          ...
          <el-form-item label="赛事名字">
            <el-button type="primary" @click="selectCompetition()" v-show="isButton"
              >选择比赛</el-button
            >
          ...
          <el-form-item label="获奖团队" v-show="isTeamName">
            <el-button type="primary" @click="selectTeamAward()" v-show="isButton"
              >选择获奖团队</el-button
            >
                        <!-- 内嵌dialog选择获奖人对应的赛事 -->
                        <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addAward(dialogData)"
          >确 定</el-button
        >
      </span>
    </el-dialog>
