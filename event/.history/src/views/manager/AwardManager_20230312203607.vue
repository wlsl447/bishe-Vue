      ...
      <div>
        <el-form ref="tableDatafrom" :model="dialogData" label-width="120px">
          ...
          <el-form-item label="获奖者">
            <el-input v-model="dialogData.userName" :disabled="isInput" v-show="isType"></el-input></el-form-item>

            <el-form-item label="获奖者">
             <el-input v-model="dialogData.teamName" :disabled="isInput"></el-input>
            </el-form-item>
