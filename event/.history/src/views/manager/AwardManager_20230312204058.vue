      ...
      <div>
        <el-form ref="tableDatafrom" :model="dialogData" label-width="120px">
          <el-form-item label="获奖名">
            <el-input v-model="dialogData.awardName" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="赛事名字">
            <el-input v-model="dialogData.cpname" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="获奖级别">
              <el-input v-model="dialogData.awardLevel" :disabled="isInput"></el-input>
            </el-form-item>
          <el-form-item label="类型"> 
            <el-input v-model="dialogData.awardType" :disabled="isInput"></el-input>
          </el-form-item>
          ...
          <el-form-item label="获奖者" v-show="isUserName">
            <el-input v-model="dialogData.userName" :disabled="isInput" v-show="isUserName"></el-input></el-form-item>

            <el-form-item label="获奖者" v-show="isTeamName">
             <el-input v-model="dialogData.teamName" :disabled="isInput" v-show="isTeamName"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleClick(row) {
      ...
      console.log(row);
      if(row.userName!=null){this.isUserName=true}
      if(row.teamName!=null){this.isTeamName=true}
      this.dialogData = row;
    },
    handleUpdate(res) {
      // this.dialogVisible = true;
