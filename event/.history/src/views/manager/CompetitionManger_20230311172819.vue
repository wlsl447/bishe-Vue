        ...
        <el-form ref="tableDatafrom" :model="tableDatafrom" label-width="120px">
          ...
          <el-form-item label="类型">
            <!-- <el-input
              ...
              :disabled="isInput"
            ></el-input> -->
            <el-select v-model="tableDatafrom.typeName" placeholder="请选择" :disabled="isInput">
              <el-option
          ...
          <el-form-item label="赛事场地">
            <el-input
              ...
              :disabled="isInput"
            ></el-input>
            <el-select v-model="tableDatafrom.address" placeholder="请选择" :disabled="isInput" @change="handleRoom">
              <el-option
          ...
          <el-form-item label="场地·具体位置">
            <el-input
              v-model="tableDatafrom.room"
              :disabled="isInput"
            ></el-input>
            <el-select v-model="tableDatafrom.room" placeholder="请选择" :disabled="isInput" >
              <el-option
