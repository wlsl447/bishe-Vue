      ...
      <div>
        <el-form ref="tableDatafrom" :model="dialogData" label-width="120px">
          ...
          <el-form-item label="获奖人" v-show="isUserName">
            ...
            >
              <el-table :data="userDate" border>
                ...
                <el-table-column prop="userunit" label="名字" width="100">
                </el-table-column>
                <el-table-column prop="username" label="名字" width="100">
                </el-table-column>
                <el-table-column prop="usergender" label="级别" width="80">
                </el-table-column>
                <el-table-column prop="userphone" label="状态" width="80">
                </el-table-column>
                <el-table-column fixed="right" width="200">
                  <template slot-scope="scope">
                    <el-button
          ...
          <el-form-item label="获奖团队" v-show="isTeamName">
            <el-button type="primary" @click="selectTeamAward()"
              >选择获奖团队</el-button
            >
            <el-input
