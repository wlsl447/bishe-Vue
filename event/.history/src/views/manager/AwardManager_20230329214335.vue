      ...
      <div>
        <el-form ref="tableDatafrom" :model="dialogData" label-width="120px">
          ...
          <el-form-item label="上传文件">
            ...
            >
              <el-button size="small" type="primary" :disabled="isShow">点击上传</el-button>
              <div slot="tip" class="el-upload__tip">
                只能上传jpg/doc/excel文件，且不超过500kb
              </div>
            </el-upload>
          </el-form-item>
          <el-form-item label="文件名">
            <el-input v-model="dialogData.name" :disabled="isShow"></el-input>
          </el-form-item>
        </el-form>
      </div>
