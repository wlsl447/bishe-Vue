...
<template>
  <div>
    <el-table :data="tableData" border :default-sort = "{prop: 'cpstime', order: 'descending'}">
      <!-- style="width: 100%" -->
      <!-- <el-table-column
        fixed
        prop="id"
      ...
      <el-table-column prop="cpstime" :formatter="dateFormat" label="开始时间" width="150" sortable>
      </el-table-column>
      <el-table-column prop="cpetime" label="结束时间" width="150" :formatter="dateFormat">
      </el-table-column>
      ...
      <el-table-column prop="teamType" label="个人赛·团体赛" width="80" sortable>
      </el-table-column>
    ...
    >
      <div>
        <el-form ref="form" :model="tableDatafrom" label-width="120px">
          <el-form-item label="赛事名字">
            <el-input v-model="tableDatafrom.cpname" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="类型">
            <el-input v-model="tableDatafrom.typeName" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="介绍">
            <el-input v-model="tableDatafrom.cpintro" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="开始时间">
            <!-- <el-input v-model="tableData.cpstime" >
            </el-input> -->
          ...
          <el-form-item label="赛事场地">
            <el-input v-model="tableDatafrom.address" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="个人赛·团体赛">
            <el-input v-model="tableDatafrom.teamType" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="级别">
            <el-input v-model="tableDatafrom.cplevel" :disabled="isInput"></el-input>
          </el-form-item>
          <el-form-item label="状态">
            <el-input v-model="tableDatafrom.cpstate" :disabled="isInput"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="addusercp(tableDatafrom.id)">报名</el-button>
        <!-- <el-button type="primary" @click="dialogVisible = false"
          >确 定</el-button
        > -->
      </span>
      ...
      this.$axios //用this.$axios就代表main.js中的Vue.prototype.$axios = axios的axios
          ...
          .then((res) => {
            ...
            if (res.data.code === 200) {
              if(res.data.data ==="该赛事是团队赛需要队伍报名"){
                this.$confirm("确认关闭？")
        .then((_) => {
          done();
        })
        .catch((_) => {});
                return  alert("该赛事是团队赛需要队伍报名");
              }
              alert("报名成功");
