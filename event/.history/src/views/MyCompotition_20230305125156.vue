...
<template>
  <div>
    <el-table :data="tableData" border>
      ...
      <el-table-column prop="cpname" label="赛事名字" width="120">
      </el-table-column>
      <el-table-column prop="typeName" label="类型"> </el-table-column>
      <el-table-column prop="cpstime" label="开始时间"> </el-table-column>
      ...
      <template slot-scope="scope">
        ...
        <el-button type="text" size="small" @click="getMyCompetition">测试</el-button>
      </template>
    </el-table-column>
...
export default {
  ...
  mounted(){
    // this.getMyCompetition(this.user.id);
  }
};
</script>
<style scoped>
