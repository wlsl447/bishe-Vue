...
<template>
  <div>
    <el-table :data="tableData" border>
      ...
      <el-table-column prop="cpname" label="队伍名" width="100">
      </el-table-column>
      <el-table-column prop="typeName" label="所属比赛"> </el-table-column>
      <!-- <el-table-column
        prop="cpstime"
        label="开始时间"
      ...
      <el-table-column prop="teamType" label="队伍状态"> </el-table-column>
