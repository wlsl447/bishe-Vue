...
import AdivceManger from '@/views/manager/AdivceManger'
import Register from '@/views/user/Register'
import CompetitionTypeManger from '@/views/manager/CompetitionTypeManger'
Vue.use(VueRouter);
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "competitionTypeManager",
        name: "competitionTypeManager",
        component: CompetitionTypeManger,
      },
      {
        path: "placeManager",
        name: "placeManager",
